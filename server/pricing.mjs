...
export const OFFICIAL_PRICING = Object.freeze([
  Object.freeze({
    ...
    long_context_input_per_million: 20,
    long_context_cached_input_per_million: 2,
    long_context_cache_write_per_million: 25,
    long_context_output_per_million: 75,
  ...
  Object.freeze({
    ...
    long_context_threshold: DEFAULT_LONG_CONTEXT_THRESHOLD,
    long_context_input_per_million: 8,
    long_context_cached_input_per_million: 0.8,
    long_context_cache_write_per_million: 10,
    long_context_output_per_million: 30,
    source_url: OFFICIAL_PRICING_URL,
  }),
  Object.freeze({
    model: "gpt-5.6-terra",
  ...
  Object.freeze({
    ...
    long_context_cache_write_per_million: 0.5,
